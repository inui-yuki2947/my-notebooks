...
- `traceroute|traceroute6`コマンドは、パケットが伝わる経路を表示する。
  ...
  ```bash
  traceroute|traceroute6 ホスト名またはIPアドレス
  ```

### tracepath|tracepath6

- `tracepath|tracepath6`コマンドは、パケットが伝わる経路を表示する。

  ```bash
  tracepath|tracepath6 ホスト名またはIPアドレス
  ```
...
- 正引きをする場合
  ...
  ```bash
  dig [@DNSサーバ] ホスト名またはドメイン名 [クエリタイプ] [クエリクラス]
  ```
